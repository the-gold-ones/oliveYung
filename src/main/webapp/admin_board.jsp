                        	...
                        	<table class="styled-table">
	                        	...
	                        	<tbody>
	                        		<tr>
	                        			...
	                        			<td>날짜</td>
	                        			<td>
	                        				<button type="button" class="btn btn-info" id="answerButton" style="width: 70px; background-color:rgb(123,125,125); border:none;" onclick="location.href='admin_boardAnswer.jsp'" onmouseover="changeAnswerColor()" onmouseout="restoreAnswerColor()">답변</button>
	                        				<button type="button" class="btn btn-info" id="deleteButton" style="width: 70px; background-color:rgb(123,125,125); border:none;" onclick="location.href='admin_board.jsp'" onmouseover="changeDeleteColor()" onmouseout="restoreDeleteColor()">삭제</button>
	                        			</td>
	                        		</tr>
	                        		<tr>
	                        			<td>글 번호</td>
