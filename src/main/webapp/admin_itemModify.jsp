...
<body id="page-top">
<form name="itemModifyForm" action="<c:url value="/ItemModifyServlet" />" method="post">
<input type="hidden" name="idx" value="<c:out value="${itemvo.idx}" />" />
                   ...
                   <!-- 문의 목록 -->
                    ...
                    <!-- 카테고리, 상품명, 상품 사진, 상품 가격, 상품 상세 설명, 상품 할인율-->
								...
								<tr>
									...
									<td><input type="text" name="title" class="form-control" style="width: 200px;" value="<c:out value="${itemvo.title }" />"> </td>
								</tr>		
								<tr>
									<td style="width: 150px; background-color:rgb(123,125,135); color:#ffffff;">상품 사진</td>
									<td>
										<img src="<c:url value="${itemvo.image}"/>" width="100" height="100" />
								...
								<tr>
									...
									<td><input type="text" name="price" class="form-control" style="width: 200px;" value="<c:out value="${itemvo.price }" />"> </td>
								</tr>	
								<tr>
									<td style="width: 150px; background-color:rgb(123,125,135); color:#ffffff;">상품 상세 설명</td>
									<td>
										<img src="<c:url value="${itemvo.detail}"/>" width="100" height="150" />
										<input type="file" name="detail" class="form-control" style="width: 300px;"> 
									</td>
								</tr>
							<!-- <tr>
