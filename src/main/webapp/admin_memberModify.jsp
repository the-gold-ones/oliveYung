                       	...
                       	<!-- 아이디, 비밀번호, 이름, 이메일, 전화번호, 멤버십 등급, 성별-->
                       		<form action="" method="post"> 
								...
								<tr>
									...
									<td><input type="text" name="id" class="form-control" style="width: 70%;" required="required"> </td>
								</tr>		
								<tr>
									<td style="width: 150px; background-color:rgb(123,125,135); color:#ffffff;">비밀번호</td>
									<td><input type="text" name="pwd" class="form-control" style="width: 70%;" required="required"> </td>
								</tr>	
								<tr>
									<td style="width: 150px; background-color:rgb(123,125,135); color:#ffffff;">이름</td>
									<td><input type="text" name="name" class="form-control" style="width: 70%;" required="required"> </td>
								</tr>	
								<tr>
									<td style="width: 150px; background-color:rgb(123,125,135); color:#ffffff;">이메일</td>
									<td><input type="text" name="email" class="form-control" style="width: 70%;" required="required"> </td>
								</tr>
								<tr>
									<td style="width: 150px; background-color:rgb(123,125,135); color:#ffffff;">전화번호</td>
									<td><input type="text" name="tel" class="form-control" style="width: 70%;" required="required"> </td>
								</tr>
								<tr>
									<td style="width: 150px; background-color:rgb(123,125,135); color:#ffffff;">성별</td>
									<td><input type="text" name="membership" class="form-control" style="width: 70%;" required="required"> </td>
								</tr>
								<tr>
								...
								<tr>
									<td colspan="2" align="center">
										...
										<button type="button" class="btn btn-info" style="width: 100px; background-color:rgb(123,125,125); border:none;" onclick="location.href='admin_member.jsp'">취소</button>
									</td>
								</tr>
								</table>
							</form>
