                        	...
                        	<table class="styled-table">
	                        	...
	                        	<c:forEach var ="item" items="${itemList }" varStatus="status">
	                        		<tr>
	                        			...
	                        			<td><img src="<c:url value="${item.image}"/>" width="100" height="100" /></td>
	                        			<td><c:out value="${item.price }"/></td>
	                        			<td><img src="<c:url value="${item.detail}"/>" width="80" height="100" /></td>
	                        			<td>
	                        				<button type="button" class="btn btn-info" id="modifyButton" style="width: 70px; background-color:rgb(123,125,125); border:none;" onclick="location.href='<c:url value="/ItemModifyServlet?idx=${item.idx}"/>'" onmouseover="changeModifyColor()" onmouseout="restoreModifyColor()">수정</button>
	                        				<button type="button" class="btn btn-info" id="deleteButton" style="width: 70px; background-color:rgb(123,125,125); border:none;" onclick="location.href='<c:url value="/ItemDeleteServlet?idx=${item.idx}"/>'" onmouseover="changeDeleteColor()" onmouseout="restoreDeleteColor()">삭제</button>
	                        			</td>
	                        			<!-- <td>상품 할인율</td> -->
	                        		</tr>
	                        	</c:forEach>
